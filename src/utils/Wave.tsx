...
class Wave extends React.Component<IWaveProps> {
	...
	private animatingClassName = 'cdk-react-wave-animation-animating'
	...
	public componentWillUnmount() {
		...
		this.node.removeEventListener('animationedn', this.animationEnd)
	}
	...
	public render() {
		...
		return typeof children === 'string' ? (
			<span className="cdk-wave-string-wrapper"></span>
		) : (
			children
		)
	}
